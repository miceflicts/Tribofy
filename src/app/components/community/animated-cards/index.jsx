...
export default function AnimatedCards() {
  ...
  return (
    <>
            ...
            >
              <motion.div layoutId={`image-${active.title}-${id}`}>
                <div
                  ...
                  src={active.src}
                  alt={active.title} */
                  className="h-80 w-full bg-highlight object-cover object-top sm:rounded-tl-lg sm:rounded-tr-lg lg:h-80"
                />
              </motion.div>
      ...
      <ul className="mx-auto grid w-full max-w-[80%] grid-cols-3 items-start gap-4 max-[1400px]:grid-cols-2 max-[700px]:grid-cols-1">
            ...
            <div className="flex w-full flex-col gap-4">
              <motion.div layoutId={`image-${card.title}-${id}`}>
                <div
                  ...
                  src={card.src}
                  alt={card.title} */
                  className="h-[180px] w-full rounded-t-xl bg-highlight object-cover object-top"
                />
              </motion.div>
              <div className="flex h-[190px] flex-col justify-between pb-4 pl-4">
                <div className="flex flex-col gap-4">
                  <motion.h3
                    layoutId={`title-${card.title}-${id}`}
                    className="text-center text-xl font-medium text-neutral-800 dark:text-neutral-200 md:text-left"
                  >
                    {card.title}
                  </motion.h3>
                  <motion.p
                ...
                <Progress className="h-[10px] w-[95%] rounded-xl" value={33} />
              </div>
            </div>
          </motion.div>
        ))}
