...
export default function WritePostTools({ applyFormatting, activeStyles }) {
  const getButtonClass = (isActive) =>
    `flex max-[420px]:h-[30px] max-[420px]:w-[30px] h-[35px] w-[35px] cursor-pointer items-center justify-center rounded-lg hover:bg-highlight ${isActive ? "bg-highlight" : ""}`;
