  ...
  return (
    <>
      <div className="flex min-h-fit w-[95%] flex-col">
        ...
        >
          <Pin size={20} className="rotate-45 text-primary-foreground"></Pin>
          <span className="text-[0.9rem] font-bold text-primary-foreground">
            Pinned
          </span>
        </div>
        ...
        {/* Post structure */}
        <div
          className={`flex min-h-fit w-full flex-col gap-4 ${isPinned ? "rounded-t-none" : ""} cursor-pointer rounded-xl border border-border bg-card px-6 py-4 hover:bg-card-hover`}
        >
          ...
          <div className="flex h-fit w-full flex-col gap-2">
            <h3 className="breakOneLine text-[1.2rem] font-bold text-text-default">
          ...
          <div className="mb-1 flex h-fit w-full items-center gap-5 max-[450px]:flex-col max-[450px]:gap-1">
            ...
            <span className="text-center text-[0.8rem] font-semibold text-text-highlight max-[450px]:mt-3">
